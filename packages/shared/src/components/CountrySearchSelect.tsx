...
export function CountrySearchSelect({
  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      {isOpen ? (
        <div className={`absolute left-0 right-0 top-[calc(100%+8px)] z-[120] overflow-hidden rounded-2xl border border-gray-700 bg-gray-900 shadow-2xl ${dropdownClassName}`}>
