...
export const ServiceInfoModal = ({ isOpen, onClose }: ServiceInfoModalProps) => {
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-end p-4 backdrop-blur-sm transition-[background-color,opacity] duration-[520ms] ease-[cubic-bezier(0.16,1,0.3,1)] sm:items-center sm:justify-center"
            style={{
        ...
        >
            ...
            <div
                ...
                className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,_rgba(8,8,8,0.98),_rgba(14,14,14,0.98))] p-5 shadow-[0_24px_60px_rgba(0,0,0,0.48)] will-change-transform"
                style={{
                    opacity: isVisible ? 1 : 0,
                ...
                <div className="relative mt-5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        <a
                            ...
                            className="group rounded-2xl border border-[#10AD0B]/25 bg-[#10AD0B]/10 p-4 transition hover:border-[#10AD0B]/45 hover:bg-[#10AD0B]/14"
                        >
