    ...
    <section className="min-h-full space-y-4 bg-gray-950 p-4 text-white">
      ...
      <article className="rounded-2xl border border-gray-800 bg-gray-900 p-4">
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
          ...
          <input type="number" value={inventoryFilters.diameter} onChange={(event) => setInventoryFilters((prev) => ({ ...prev, diameter: event.target.value }))} placeholder="Діаметр" className="rounded-lg border border-gray-700 bg-gray-950 px-3 py-2 text-white outline-none focus:border-blue-500" />
          <input type="number" value={inventoryFilters.sellPrice} onChange={(event) => setInventoryFilters((prev) => ({ ...prev, sellPrice: event.target.value }))} placeholder="Ціна продажу" className="rounded-lg border border-gray-700 bg-gray-950 px-3 py-2 text-white outline-none focus:border-blue-500" />
